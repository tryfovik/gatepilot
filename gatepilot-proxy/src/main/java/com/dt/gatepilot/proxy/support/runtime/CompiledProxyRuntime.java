...
public class CompiledProxyRuntime {
     ...
     * @return 运行态摘要
     */
    public com.dt.gatepilot.proxy.api.ProxyRuntimeSnapshot snapshot() {
        com.dt.gatepilot.proxy.api.ProxyRuntimeSnapshot snapshot =
                new com.dt.gatepilot.proxy.api.ProxyRuntimeSnapshot();
