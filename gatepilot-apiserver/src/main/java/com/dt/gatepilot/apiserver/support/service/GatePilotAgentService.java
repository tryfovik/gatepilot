...
import com.dt.gatepilot.api.enums.NodePhase;
...
public class GatePilotAgentService {
     ...
     * @return 节点资源
     */
    public GatewayNode register(AgentRegisterRequest request) {
    ...
    public AgentConfigPullResponse pullConfig(AgentConfigPullRequest request) {
        CursorPageResponse<Object> page = resourceService.list("published-configs", request.getNamespace(), null, 500);
